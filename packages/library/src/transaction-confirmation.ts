import type { AccountNotificationsApi, GetAccountInfoApi, GetSignatureStatusesApi, SignatureNotificationsApi, Slot, SlotNotificationsApi } from '@solana/rpc-core';
